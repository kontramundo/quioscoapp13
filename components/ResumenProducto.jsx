...
export default function ResumenProducto({ producto }) {
    const { handleChangeCantidad, handleDeleteProducto } = useQuioscoContext();
        ...
        <div className="shadow p-5 mb-3 flex gap-10 items-center">
            ...
            <div>
                <button
                    ...
                    onClick={() => handleChangeCantidad(producto.id)}
                >
                    <svg
                ...
                <button
                    type="button"
                    className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md text-center mt-3 w-full"
